sync WhenArticleGetBySlugRefusedThenWebRespondForCommentOnArticle
...
- `../01_usecase/output/usecase.md` — scenarios "add-comment", "delete-comment", extension "article not found"
