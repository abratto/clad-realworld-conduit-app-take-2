sync WhenSessionLookupRefusedThenWebRespondForManageArticles
...
- `../01_usecase/output/usecase.md` — scenarios "create-article", "update-article", "delete-article", extension "invalid token"
