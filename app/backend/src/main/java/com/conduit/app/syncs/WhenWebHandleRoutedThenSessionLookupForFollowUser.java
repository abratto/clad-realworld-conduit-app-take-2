...
@Singleton
public final class WhenWebHandleRoutedThenSessionLookupForFollowUser extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    @Inject public WhenWebHandleRoutedThenSessionLookupForFollowUser(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenWebHandleRoutedThenSessionLookupForFollowUser"; }
