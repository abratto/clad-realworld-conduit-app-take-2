...
@Singleton
public final class WhenSessionLookupFoundThenArticleGetBySlugForFavoriteArticle extends SyncAgent {
    @Inject public WhenSessionLookupFoundThenArticleGetBySlugForFavoriteArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupFoundThenArticleGetBySlugForFavoriteArticle"; }
