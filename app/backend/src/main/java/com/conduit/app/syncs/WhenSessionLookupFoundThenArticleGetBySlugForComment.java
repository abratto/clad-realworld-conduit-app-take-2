...
@Singleton
public final class WhenSessionLookupFoundThenArticleGetBySlugForComment extends SyncAgent {
    ...
    @Inject public WhenSessionLookupFoundThenArticleGetBySlugForComment(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupFoundThenArticleGetBySlugForComment"; }
