...
@Singleton
public final class WhenSessionLookupRefusedThenWebRespondForArticle extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String ARTICLE_ROUTE = "/api/articles";
    @Inject public WhenSessionLookupRefusedThenWebRespondForArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupRefusedThenWebRespondForArticle"; }
