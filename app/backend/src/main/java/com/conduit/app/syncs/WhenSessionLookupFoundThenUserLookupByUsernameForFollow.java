...
@Singleton
public final class WhenSessionLookupFoundThenUserLookupByUsernameForFollow extends SyncAgent {
    @Inject public WhenSessionLookupFoundThenUserLookupByUsernameForFollow(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupFoundThenUserLookupByUsernameForFollow"; }
