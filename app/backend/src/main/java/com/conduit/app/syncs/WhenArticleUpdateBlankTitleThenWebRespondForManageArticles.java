...
@Singleton
public final class WhenArticleUpdateBlankTitleThenWebRespondForManageArticles extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String ARTICLE_ROUTE = "/api/articles";
    @Inject public WhenArticleUpdateBlankTitleThenWebRespondForManageArticles(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenArticleUpdateBlankTitleThenWebRespondForManageArticles"; }
