...
@Singleton
public final class WhenArticleAuthorCheckNotAuthorThenWebRespondForManageArticles extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String ARTICLE_ROUTE = "/api/articles";
    @Inject public WhenArticleAuthorCheckNotAuthorThenWebRespondForManageArticles(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenArticleAuthorCheckNotAuthorThenWebRespondForManageArticles"; }
