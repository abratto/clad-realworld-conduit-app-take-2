...
@Singleton
public final class WhenCommentAuthorCheckNotAuthorThenWebRespondForCommentOnArticle extends SyncAgent {
    ...
    @Inject public WhenCommentAuthorCheckNotAuthorThenWebRespondForCommentOnArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenCommentAuthorCheckNotAuthorThenWebRespondForCommentOnArticle"; }
