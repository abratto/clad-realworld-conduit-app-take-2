...
@Singleton
public final class WhenSessionLookupFoundThenCommentAuthorCheckForComment extends SyncAgent {
    ...
    @Inject public WhenSessionLookupFoundThenCommentAuthorCheckForComment(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupFoundThenCommentAuthorCheckForComment"; }
