...
@Singleton
public final class WhenWebHandleRoutedThenSessionLookupForViewFeed extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String FEED_ROUTE = "/api/articles/feed";
    @Inject public WhenWebHandleRoutedThenSessionLookupForViewFeed(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenWebHandleRoutedThenSessionLookupForViewFeed"; }
    ...
    @Override protected String parameterizeSparql(String sparql) {
        return bindLiteral(sparql, "_route", FEED_ROUTE);
    }
}
