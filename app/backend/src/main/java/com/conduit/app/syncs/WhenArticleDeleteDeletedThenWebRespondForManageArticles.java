...
@SyncMetadata(flow = "Article", step = 9, triggeredBy = "Article/delete[Deleted]", fires = "Web/respond[204]")
@Singleton
public final class WhenArticleDeleteDeletedThenWebRespondForManageArticles extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String ARTICLE_ROUTE = "/api/articles";
    @Inject public WhenArticleDeleteDeletedThenWebRespondForManageArticles(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenArticleDeleteDeletedThenWebRespondForManageArticles"; }
    @Override public SyncTrigger trigger() { return new SyncTrigger(ArticleConcept.IRI, "delete", null); }
    ...
    @Override protected String thenBindings() {
        return "?_then_1 :concept <%s> ; :name \"respond\" ; :input [ :statusCode 204 ] .".formatted(WEB_IRI);
    }
