...
@Singleton
public final class WhenCommentAddAddedThenWebRespondForComment extends SyncAgent {
    ...
    @Inject public WhenCommentAddAddedThenWebRespondForComment(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenCommentAddAddedThenWebRespondForComment"; }
