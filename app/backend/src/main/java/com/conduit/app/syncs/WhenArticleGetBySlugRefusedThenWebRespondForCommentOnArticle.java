...
@SyncMetadata(flow = "Comment", step = 6, triggeredBy = "Article/getBySlug[refused]", fires = "Web/respond[404]")
@Singleton
public final class WhenArticleGetBySlugRefusedThenWebRespondForCommentOnArticle extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String COMMENT_ROUTE = "/api/articles";
    @Inject public WhenArticleGetBySlugRefusedThenWebRespondForCommentOnArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenArticleGetBySlugRefusedThenWebRespondForCommentOnArticle"; }
