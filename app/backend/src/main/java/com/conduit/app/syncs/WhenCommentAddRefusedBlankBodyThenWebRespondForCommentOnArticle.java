...
@Singleton
public final class WhenCommentAddRefusedBlankBodyThenWebRespondForCommentOnArticle extends SyncAgent {
    ...
    @Inject public WhenCommentAddRefusedBlankBodyThenWebRespondForCommentOnArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenCommentAddRefusedBlankBodyThenWebRespondForCommentOnArticle"; }
