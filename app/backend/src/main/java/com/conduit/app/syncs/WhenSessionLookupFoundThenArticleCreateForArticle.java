...
@SyncMetadata(flow = "Article", step = 5, triggeredBy = "Session/lookup[FOUND]", fires = "Article/create")
@Singleton
public final class WhenSessionLookupFoundThenArticleCreateForArticle extends SyncAgent {
    ...
    @Inject public WhenSessionLookupFoundThenArticleCreateForArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupFoundThenArticleCreateForArticle"; }
