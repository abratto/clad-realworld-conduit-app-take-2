...
@Singleton
public final class WhenSessionLookupFoundThenArticleCreateForManageArticles extends SyncAgent {
    ...
    @Inject public WhenSessionLookupFoundThenArticleCreateForManageArticles(ActionLog l) { super(l); }
