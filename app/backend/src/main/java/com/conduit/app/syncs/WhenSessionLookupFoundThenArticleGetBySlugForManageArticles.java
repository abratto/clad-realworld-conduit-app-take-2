...
@SyncMetadata(flow = "Article", step = 5, triggeredBy = "Session/lookup[FOUND]", fires = "Article/getBySlug")
@Singleton
public final class WhenSessionLookupFoundThenArticleGetBySlugForManageArticles extends SyncAgent {
    ...
    @Inject public WhenSessionLookupFoundThenArticleGetBySlugForManageArticles(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupFoundThenArticleGetBySlugForManageArticles"; }
