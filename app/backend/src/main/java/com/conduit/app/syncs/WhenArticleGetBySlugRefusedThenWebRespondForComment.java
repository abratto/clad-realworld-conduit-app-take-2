...
@Singleton
public final class WhenArticleGetBySlugRefusedThenWebRespondForComment extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String COMMENT_ROUTE = "/api/articles";
    @Inject public WhenArticleGetBySlugRefusedThenWebRespondForComment(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenArticleGetBySlugRefusedThenWebRespondForComment"; }
