...
@SyncMetadata(flow = "Article", step = 4, triggeredBy = "Session/lookup[refused]", fires = "Web/respond[401]")
@Singleton
public final class WhenSessionLookupRefusedThenWebRespondForManageArticles extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String ARTICLE_ROUTE = "/api/articles";
    @Inject public WhenSessionLookupRefusedThenWebRespondForManageArticles(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupRefusedThenWebRespondForManageArticles"; }
