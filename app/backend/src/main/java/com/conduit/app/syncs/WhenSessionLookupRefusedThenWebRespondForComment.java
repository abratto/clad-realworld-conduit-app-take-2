...
@Singleton
public final class WhenSessionLookupRefusedThenWebRespondForComment extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String COMMENT_ROUTE = "/api/articles";
    @Inject public WhenSessionLookupRefusedThenWebRespondForComment(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupRefusedThenWebRespondForComment"; }
