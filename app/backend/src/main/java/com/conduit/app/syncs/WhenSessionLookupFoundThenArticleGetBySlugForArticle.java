...
@Singleton
public final class WhenSessionLookupFoundThenArticleGetBySlugForArticle extends SyncAgent {
    ...
    @Inject public WhenSessionLookupFoundThenArticleGetBySlugForArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupFoundThenArticleGetBySlugForArticle"; }
