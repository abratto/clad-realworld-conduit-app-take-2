...
@Singleton
public final class WhenWebHandleRoutedThenSessionLookupForFavorite extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    @Inject public WhenWebHandleRoutedThenSessionLookupForFavorite(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenWebHandleRoutedThenSessionLookupForFavorite"; }
