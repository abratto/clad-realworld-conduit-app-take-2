...
@Singleton
public final class WhenCommentAuthorCheckIsAuthorThenCommentDeleteForComment extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String COMMENT_IRI = "https://clad.dev/concept/comment";
    @Inject public WhenCommentAuthorCheckIsAuthorThenCommentDeleteForComment(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenCommentAuthorCheckIsAuthorThenCommentDeleteForComment"; }
