...
@Singleton
public final class WhenArticleAuthorCheckIsAuthorThenArticleUpdateForArticle extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    @Inject public WhenArticleAuthorCheckIsAuthorThenArticleUpdateForArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenArticleAuthorCheckIsAuthorThenArticleUpdateForArticle"; }
