...
@Singleton
public final class WhenCommentAddBlankBodyThenWebRespondForCommentOnArticle extends SyncAgent {
    ...
    @Inject public WhenCommentAddBlankBodyThenWebRespondForCommentOnArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenCommentAddBlankBodyThenWebRespondForCommentOnArticle"; }
