...
@Singleton
public final class WhenArticleGetBySlugFoundThenArticleAuthorCheckForArticle extends SyncAgent {
    @Inject public WhenArticleGetBySlugFoundThenArticleAuthorCheckForArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenArticleGetBySlugFoundThenArticleAuthorCheckForArticle"; }
