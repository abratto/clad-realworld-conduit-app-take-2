...
@Singleton
public final class WhenWebHandleRoutedThenArticleGetBySlugForViewComments extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String ARTICLES_ROUTE = "/api/articles";
    @Inject public WhenWebHandleRoutedThenArticleGetBySlugForViewComments(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenWebHandleRoutedThenArticleGetBySlugForViewComments"; }
