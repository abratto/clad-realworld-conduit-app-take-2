...
@Singleton
public final class WhenArticleGetBySlugFoundThenFavoriteFavoriteForFavoriteArticle extends SyncAgent {
    @Inject public WhenArticleGetBySlugFoundThenFavoriteFavoriteForFavoriteArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenArticleGetBySlugFoundThenFavoriteFavoriteForFavoriteArticle"; }
