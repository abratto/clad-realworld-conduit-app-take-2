...
@Singleton
public final class WhenWebHandleNoTokenThenWebRespondForManageArticles extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String ARTICLE_ROUTE = "/api/articles";
    @Inject public WhenWebHandleNoTokenThenWebRespondForManageArticles(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenWebHandleNoTokenThenWebRespondForManageArticles"; }
