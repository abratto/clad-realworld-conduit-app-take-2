...
@Singleton
public final class WhenSessionLookupFoundThenCommentAddForComment extends SyncAgent {
    ...
    @Inject public WhenSessionLookupFoundThenCommentAddForComment(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupFoundThenCommentAddForComment"; }
