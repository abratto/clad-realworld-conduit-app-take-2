...
@Singleton
public final class WhenFollowFollowedThenWebRespondForFollow extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    @Inject public WhenFollowFollowedThenWebRespondForFollow(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenFollowFollowedThenWebRespondForFollow"; }
