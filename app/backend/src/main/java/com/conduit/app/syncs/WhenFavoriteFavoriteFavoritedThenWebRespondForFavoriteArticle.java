...
@Singleton
public final class WhenFavoriteFavoriteFavoritedThenWebRespondForFavoriteArticle extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    @Inject public WhenFavoriteFavoriteFavoritedThenWebRespondForFavoriteArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenFavoriteFavoriteFavoritedThenWebRespondForFavoriteArticle"; }
