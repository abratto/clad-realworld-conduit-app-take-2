...
@Singleton
public final class WhenArticleAuthorCheckIsAuthorThenArticleDeleteForArticle extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    @Inject public WhenArticleAuthorCheckIsAuthorThenArticleDeleteForArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenArticleAuthorCheckIsAuthorThenArticleDeleteForArticle"; }
