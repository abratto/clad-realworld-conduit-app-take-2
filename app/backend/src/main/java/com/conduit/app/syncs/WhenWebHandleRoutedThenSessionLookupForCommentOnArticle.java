...
@SyncMetadata(flow = "Comment", step = 3, triggeredBy = "Web/handle[Routed]", fires = "Session/lookup")
@Singleton
public final class WhenWebHandleRoutedThenSessionLookupForCommentOnArticle extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String COMMENT_ROUTE = "/api/articles";
    @Inject public WhenWebHandleRoutedThenSessionLookupForCommentOnArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenWebHandleRoutedThenSessionLookupForCommentOnArticle"; }
