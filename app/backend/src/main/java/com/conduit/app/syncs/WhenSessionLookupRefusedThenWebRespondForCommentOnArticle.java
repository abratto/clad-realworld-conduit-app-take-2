...
@SyncMetadata(flow = "Comment", step = 4, triggeredBy = "Session/lookup[refused]", fires = "Web/respond[401]")
@Singleton
public final class WhenSessionLookupRefusedThenWebRespondForCommentOnArticle extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String COMMENT_ROUTE = "/api/articles";
    @Inject public WhenSessionLookupRefusedThenWebRespondForCommentOnArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenSessionLookupRefusedThenWebRespondForCommentOnArticle"; }
    ...
    @Override protected String thenBindings() {
        return "?_then_1 :concept <%s> ; :name \"respond\" ; :input [ :statusCode 401 ; :message \"unauthorized\" ] .".formatted(WEB_IRI);
    }
