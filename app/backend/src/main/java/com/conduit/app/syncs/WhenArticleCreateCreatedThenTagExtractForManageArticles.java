...
@Singleton
public final class WhenArticleCreateCreatedThenTagExtractForManageArticles extends SyncAgent {
    private static final String TAG_IRI = "https://clad.dev/concept/tag";
    @Inject public WhenArticleCreateCreatedThenTagExtractForManageArticles(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenArticleCreateCreatedThenTagExtractForManageArticles"; }
