...
@Singleton
public final class WhenCommentDeleteDeletedThenWebRespondForCommentOnArticle extends SyncAgent {
    ...
    @Inject public WhenCommentDeleteDeletedThenWebRespondForCommentOnArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenCommentDeleteDeletedThenWebRespondForCommentOnArticle"; }
