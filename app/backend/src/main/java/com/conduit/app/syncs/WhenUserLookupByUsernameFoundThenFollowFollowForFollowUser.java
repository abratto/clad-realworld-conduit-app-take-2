...
@Singleton
public final class WhenUserLookupByUsernameFoundThenFollowFollowForFollowUser extends SyncAgent {
    @Inject public WhenUserLookupByUsernameFoundThenFollowFollowForFollowUser(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenUserLookupByUsernameFoundThenFollowFollowForFollowUser"; }
