...
@Singleton
public final class WhenTagExtractExtractedThenWebRespondForManageArticles extends SyncAgent {
    ...
    @Inject public WhenTagExtractExtractedThenWebRespondForManageArticles(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenTagExtractExtractedThenWebRespondForManageArticles"; }
