...
@SyncMetadata(flow = "Article", step = 9, triggeredBy = "Article/update[refused] (blank title)", fires = "Web/respond[422]")
@Singleton
public final class WhenArticleUpdateRefusedBlankTitleThenWebRespondForArticle extends SyncAgent {
    private static final String WEB_IRI = FlowManager.WEB_CONCEPT_IRI;
    private static final String ARTICLE_ROUTE = "/api/articles";
    @Inject public WhenArticleUpdateRefusedBlankTitleThenWebRespondForArticle(ActionLog l) { super(l); }
    @Override public String syncName() { return "whenArticleUpdateRefusedBlankTitleThenWebRespondForArticle"; }
    @Override public SyncTrigger trigger() { return new SyncTrigger(ArticleConcept.IRI, "update", null); }
    @Override protected String whereClause() {
        return "?_when_1 :concept <%s> ; :name \"update\" ; :flow ?_flow ; :refusalReason ?_reason .\n<< ?_when_1 :outcome \"refused\" >> :flow ?_flow .\nFILTER(CONTAINS(?_reason, \"blank\"))\n?_req :concept <%s> ; :name \"request\" ; :flow ?_flow ; :input ?_inp .\n?_inp :route ?_route .".formatted(ArticleConcept.IRI, WEB_IRI);
    }
